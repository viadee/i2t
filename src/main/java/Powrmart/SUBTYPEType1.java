...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>SUBTYPE Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see Powrmart.PowrmartPackage#getSUBTYPEType1()
 * @model extendedMetaData="name='SUBTYPE_._1_._type'"
 * @generated
 */
public enum SUBTYPEType1 implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>SUBTYPE Type1</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final SUBTYPEType1[] VALUES_ARRAY =
        new SUBTYPEType1[] {
            STRUCTURETYPE,
            STRUCTUREFIELDTYPE,
            ABAPTYPE,
    ...
    /**
     * A public read-only list of all the '<em><b>SUBTYPE Type1</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<SUBTYPEType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>SUBTYPE Type1</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static SUBTYPEType1 get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            SUBTYPEType1 result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>SUBTYPE Type1</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static SUBTYPEType1 getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            SUBTYPEType1 result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>SUBTYPE Type1</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static SUBTYPEType1 get(int value) {
        switch (value) {
     ...
     * @generated
     */
    private SUBTYPEType1(int value, String name, String literal) {
        this.value = value;
        this.name = name;
