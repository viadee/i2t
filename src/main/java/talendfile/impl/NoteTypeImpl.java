 ...
 * <ul>
 *   <li>{@link talendfile.impl.NoteTypeImpl#isOpaque <em>Opaque</em>}</li>
 *   <li>{@link talendfile.impl.NoteTypeImpl#getPosX <em>Pos X</em>}</li>
 *   <li>{@link talendfile.impl.NoteTypeImpl#getPosY <em>Pos Y</em>}</li>
 *   <li>{@link talendfile.impl.NoteTypeImpl#getSizeHeight <em>Size Height</em>}</li>
 *   <li>{@link talendfile.impl.NoteTypeImpl#getSizeWidth <em>Size Width</em>}</li>
 *   <li>{@link talendfile.impl.NoteTypeImpl#getText <em>Text</em>}</li>
 *   <li>{@link talendfile.impl.NoteTypeImpl#getElementParameter <em>Element Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NoteTypeImpl extends EObjectImpl implements NoteType {
    ...
    public EList<ElementParameterType> getElementParameter() {
        if (elementParameter == null) {
            elementParameter = new EObjectContainmentEList<ElementParameterType>(ElementParameterType.class, this, TalendfilePackage.NOTE_TYPE__ELEMENT_PARAMETER);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case TalendfilePackage.NOTE_TYPE__POS_Y:
                ...
                return;
            case TalendfilePackage.NOTE_TYPE__SIZE_HEIGHT:
                setSizeHeight((Integer)newValue);
                return;
            case TalendfilePackage.NOTE_TYPE__SIZE_WIDTH:
                setSizeWidth((Integer)newValue);
                return;
            case TalendfilePackage.NOTE_TYPE__TEXT:
