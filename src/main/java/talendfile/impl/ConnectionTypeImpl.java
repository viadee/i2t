 ...
 * <ul>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getElementParameter <em>Element Parameter</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getConnectorName <em>Connector Name</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getLineStyle <em>Line Style</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getMergeOrder <em>Merge Order</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getMetaname <em>Metaname</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getOffsetLabelX <em>Offset Label X</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getOffsetLabelY <em>Offset Label Y</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getOutputId <em>Output Id</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link talendfile.impl.ConnectionTypeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectionTypeImpl extends EObjectImpl implements ConnectionType {
    ...
    public EList<ElementParameterType> getElementParameter() {
        if (elementParameter == null) {
            elementParameter = new EObjectContainmentEList<ElementParameterType>(ElementParameterType.class, this, TalendfilePackage.CONNECTION_TYPE__ELEMENT_PARAMETER);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case TalendfilePackage.CONNECTION_TYPE__LINE_STYLE:
                ...
                return;
            case TalendfilePackage.CONNECTION_TYPE__MERGE_ORDER:
                setMergeOrder((Integer)newValue);
                return;
            case TalendfilePackage.CONNECTION_TYPE__METANAME:
