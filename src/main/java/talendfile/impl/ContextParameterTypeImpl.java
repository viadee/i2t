 ...
 * <ul>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#getPrompt <em>Prompt</em>}</li>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#isPromptNeeded <em>Prompt Needed</em>}</li>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#getRepositoryContextId <em>Repository Context Id</em>}</li>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link talendfile.impl.ContextParameterTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case TalendfilePackage.CONTEXT_PARAMETER_TYPE__PROMPT:
                ...
                return;
            case TalendfilePackage.CONTEXT_PARAMETER_TYPE__PROMPT_NEEDED:
                setPromptNeeded((Boolean)newValue);
                return;
            case TalendfilePackage.CONTEXT_PARAMETER_TYPE__REPOSITORY_CONTEXT_ID:
