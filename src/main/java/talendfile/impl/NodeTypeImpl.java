 ...
 * <ul>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getElementParameter <em>Element Parameter</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getBinaryData <em>Binary Data</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getStringData <em>String Data</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getComponentName <em>Component Name</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getComponentVersion <em>Component Version</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getOffsetLabelX <em>Offset Label X</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getOffsetLabelY <em>Offset Label Y</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getPosX <em>Pos X</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getPosY <em>Pos Y</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getSizeX <em>Size X</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getSizeY <em>Size Y</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getScreenshot <em>Screenshot</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getNodeData <em>Node Data</em>}</li>
 *   <li>{@link talendfile.impl.NodeTypeImpl#getNodeContainer <em>Node Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeTypeImpl extends EObjectImpl implements NodeType {
    ...
    public EList<ElementParameterType> getElementParameter() {
        if (elementParameter == null) {
            elementParameter = new EObjectContainmentEList<ElementParameterType>(ElementParameterType.class, this, TalendfilePackage.NODE_TYPE__ELEMENT_PARAMETER);
        }
    ...
    public EList<MetadataType> getMetadata() {
        if (metadata == null) {
            metadata = new EObjectContainmentEList<MetadataType>(MetadataType.class, this, TalendfilePackage.NODE_TYPE__METADATA);
        }
        return metadata;
    }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case TalendfilePackage.NODE_TYPE__COMPONENT_VERSION:
                ...
                return;
            case TalendfilePackage.NODE_TYPE__OFFSET_LABEL_X:
                setOffsetLabelX((Integer)newValue);
                return;
            case TalendfilePackage.NODE_TYPE__OFFSET_LABEL_Y:
                setOffsetLabelY((Integer)newValue);
                return;
            case TalendfilePackage.NODE_TYPE__POS_X:
