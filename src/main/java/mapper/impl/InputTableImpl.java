 ...
 * <ul>
 *   <li>{@link mapper.impl.InputTableImpl#getMatchingMode <em>Matching Mode</em>}</li>
 *   <li>{@link mapper.impl.InputTableImpl#getLookupMode <em>Lookup Mode</em>}</li>
 *   <li>{@link mapper.impl.InputTableImpl#getGlobalMapKeysValues <em>Global Map Keys Values</em>}</li>
 *   <li>{@link mapper.impl.InputTableImpl#isInnerJoin <em>Inner Join</em>}</li>
 *   <li>{@link mapper.impl.InputTableImpl#isPersistent <em>Persistent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
