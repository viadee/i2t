 ...
 * <ul>
 *   <li>{@link mapper.impl.OutputTableImpl#isReject <em>Reject</em>}</li>
 *   <li>{@link mapper.impl.OutputTableImpl#isRejectInnerJoin <em>Reject Inner Join</em>}</li>
 *   <li>{@link mapper.impl.OutputTableImpl#isIsErrorRejectTable <em>Is Error Reject Table</em>}</li>
 *   <li>{@link mapper.impl.OutputTableImpl#getIsJoinTableOf <em>Is Join Table Of</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
