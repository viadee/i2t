 ...
 * <!-- end-user-doc -->
 * @see mapper.MapperPackage#getOperator()
 * @model
 * @generated
 */
public enum Operator implements Enumerator {
     ...
     * @ordered
     */
    LOWER_OR_EQUALS(3, "Lower_or_equals", "<="),
     ...
     * @ordered
     */
    GREATER_OR_EQUALS(5, "Greater_or_equals", ">=");
     ...
     * @ordered
     */
    public static final int GREATER_OR_EQUALS_VALUE = 5;
